...
import DrawerCollectionCard from "Components/DrawerCollectionCard";
var _=require('lodash');

export default function Drawer({ isOpen, setIsOpen, collection, addToCollection, restaurant_id }) {
    return (
        ...
        <section className={
            ...
            {
                addToCollection? <DrawerCollectionCard restaurant_id={restaurant_id}/> : <CollectionRestaurantCard collection={collection}/>
            }
        </section>
